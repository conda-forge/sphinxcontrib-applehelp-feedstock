...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6466&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sphinxcontrib-applehelp-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sphinxcontrib-applehelp` can be installed with:

```
conda install sphinxcontrib-applehelp
```

It is possible to list all of the versions of `sphinxcontrib-applehelp` available on your platform with:
